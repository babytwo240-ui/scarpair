...
import { logUserVerified, logUserDeleted } from '../../shared/utils/auditLogger';
import { MappedUser } from './users.types';

const NODE_ENV = process.env.NODE_ENV || 'development';

const mapUser = (user: any): MappedUser => ({
  id: user.id,
  email: user.email,
  ...
  ...(user.type === 'business' && { businessName: user.businessName }),
  ...(user.type === 'recycler' && { companyName: user.companyName })
});
