...
exports.getPointDeduction = exports.shouldAutoApprove = exports.validateReportReason = void 0;
...
const validateReportReason = (reason, description, wasteType) => {
    ...
    const validation = VALIDATION_KEYWORDS[reason];
    if (!validation) {
        return {
            isValid: true,
            validityScore: 0.6,
...
const shouldAutoApprove = (reason, validityScore, pointsDeduction) => {
...
const getPointDeduction = (reason, validityScore, basePoints) => {
    if (validityScore < 0.4) {
        return 0;
    }
    return basePoints * (validityScore / 1.0);
};
exports.getPointDeduction = getPointDeduction;
