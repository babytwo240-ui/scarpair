...
const submitReport = async (req: Request, res: Response): Promise<any> => {
  try {
...
const getPendingReports = async (req: Request, res: Response): Promise<any> => {
  try {
...
const approveReport = async (req: Request, res: Response): Promise<any> => {
  try {
...
const rejectReport = async (req: Request, res: Response): Promise<any> => {
  try {
    const { reportId } = req.params;
...
const getUserReports = async (req: Request, res: Response): Promise<any> => {
  try {
