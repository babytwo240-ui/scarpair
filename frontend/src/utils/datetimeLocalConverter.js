...
export const convertBrowserLocalToManilaTime = (dateTimeLocalString) => {
  ...
  console.log('🔍 convertBrowserLocalToManilaTime DEBUG:');
  console.log('   Input (treat as Manila time):', dateTimeLocalString);
  console.log('   Passing directly to backend (already in Manila format)');
