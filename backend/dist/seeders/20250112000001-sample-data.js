...
module.exports = {
    up: async (queryInterface, Sequelize) => {
        ...
        const users = await queryInterface.sequelize.query('SELECT id FROM users WHERE email IN (?, ?)', {
...
//# sourceMappingURL=20250112000001-sample-data.js.map