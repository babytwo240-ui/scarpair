        ...
        <form onSubmit={handleSubmit} style={{ display: 'grid', gap: 24, marginBottom: 60 }}>
          <div style={{ background: C.surface, border: `1px solid ${C.border}`, borderRadius: 24, padding: 40, display: 'grid', gap: 24 }}>
            ...
            {user.type === 'business' && <div>
              ...
              <input type="text" name="businessName" value={formData.businessName} onChange={handleChange} onFocus={() => setFocusedField('businessName')} onBlur={() => setFocusedField(null)} required placeholder="Your business name" style={{ width: '100%', padding: '12px 16px', border: `1px solid ${focusedField === 'businessName' ? C.borderHover : C.border}`, borderRadius: 14, background: 'rgba(100,255,67,0.03)', color: C.text, fontSize: 14, boxSizing: 'border-box', transition: 'all 0.2s ease', outline: 'none', boxShadow: focusedField === 'businessName' ? `0 0 0 3px rgba(100,255,67,0.1)` : 'none' }} />
            </div>}
            ...
            {user.type === 'recycler' && <>
              <div>
                ...
                <input type="text" name="companyName" value={formData.companyName} onChange={handleChange} onFocus={() => setFocusedField('companyName')} onBlur={() => setFocusedField(null)} required placeholder="Your company name" style={{ width: '100%', padding: '12px 16px', border: `1px solid ${focusedField === 'companyName' ? C.borderHover : C.border}`, borderRadius: 14, background: 'rgba(100,255,67,0.03)', color: C.text, fontSize: 14, boxSizing: 'border-box', transition: 'all 0.2s ease', outline: 'none', boxShadow: focusedField === 'companyName' ? `0 0 0 3px rgba(100,255,67,0.1)` : 'none' }} />
              </div>
              <div>
