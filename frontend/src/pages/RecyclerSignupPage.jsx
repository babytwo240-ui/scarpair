        ...
        <div style={{ maxWidth: 480, margin: '0 auto', width: '100%' }}>
          ...
          <div style={{ marginBottom: 48, animation: 'fadeUp 0.7s ease both' }}>
            ...
            <p style={{
              ...
              Join Scrapair and start discovering recycling opportunities.
            </p>
          </div>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
              ...
              <div>
                ...
                <input
                  ...
                  required
                  placeholder="Eco Recycling Inc."
                  style={{
                    width: '100%',
                    padding: '12px 16px',
                    background: C.bgDeep,
                    border: `1px solid ${focusedInput === 'companyName' ? C.primary : C.border}`,
                    borderRadius: 4,
                    color: C.text,
                    fontSize: 14,
                    fontFamily: "'Outfit', sans-serif",
                    ...
                    outline: 'none',
                    boxShadow: focusedInput === 'companyName' ? `0 0 0 2px ${C.glowStrong}` : 'none',
                  }}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onBlur={() => setFocusedInput(null)}
                  required
                  placeholder="hello@ecorecycling.com"
                  style={{
                    width: '100%',
                    padding: '12px 16px',
                    background: C.bgDeep,
                ...
                <div>
                  ...
                  <input
                    ...
                    style={{
                      ...
                      padding: '12px 16px',
                      background: C.bgDeep,
                      border: `1px solid ${focusedInput === 'specialization' ? C.primary : C.border}`,
                      borderRadius: 4,
                      color: C.text,
                      fontSize: 14,
                      fontFamily: "'Outfit', sans-serif",
                      transition: 'all 0.2s ease',
                      outline: 'none',
                      boxShadow: focusedInput === 'specialization' ? `0 0 0 2px ${C.glowStrong}` : 'none',
                    }}
                  />
                </div>
              </div>
