...
export const ReviewController = {
  ...
  getBusinessReviews: async (req: Request, res: Response): Promise<any> => {
    try {
  ...
  getBusinessRating: async (req: Request, res: Response): Promise<any> => {
    try {
      const { businessId } = req.params;
  ...
  deleteReview: async (req: Request, res: Response): Promise<any> => {
    try {
      const { reviewId } = req.params;
      const userId = req.user?.id;
