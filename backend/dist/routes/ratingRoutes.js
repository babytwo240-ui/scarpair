...
router.get('/admin/users', adminAuthMiddleware_1.authenticateAdmin, ratingController.getAllUserRatings);
router.get('/admin/posts', adminAuthMiddleware_1.authenticateAdmin, ratingController.getAllPostRatings);
